package com.felipe.course.workshopmongo.config;
...
import com.felipe.course.workshopmongo.dto.AuthorDTO;
import com.felipe.course.workshopmongo.dto.CommentDTO;
...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		CommentDTO c2 = new CommentDTO( "Arpoveite", sdf.parse("22/03/2018"), new AuthorDTO(bob));
